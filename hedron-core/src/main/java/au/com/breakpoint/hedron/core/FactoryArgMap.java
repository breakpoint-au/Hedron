...
/** Threadsafe */
public class FactoryArgMap<K, V> extends ForwardingMap<K, V>
{
    public FactoryArgMap (final IFactoryArg<K, V> factory)
    {
    ...
    public V get (final Object key)
    {
        ...
        if (e == null)
        {
            ...
            final V newInstance = m_factory.newInstance (k);
    ...
    /** Factory method */
    public static <K, V> FactoryArgMap<K, V> of (final IFactoryArg<K, V> factory)
    {
        return new FactoryArgMap<K, V> (factory);
    }

    private final IFactoryArg<K, V> m_factory;
}
