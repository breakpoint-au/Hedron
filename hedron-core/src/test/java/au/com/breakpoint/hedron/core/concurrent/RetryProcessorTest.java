...
public class RetryProcessorTest
{
    ...
    {
        final IProcessor rp = new RetryProcessor ( () -> new ProcessorMock ("", false, MSEC_RUN_DURATION / 10), 0);
    ...
    {
        final IProcessor rp =
            new RetryProcessor ( () -> new ProcessorMock ("", true, MSEC_RUN_DURATION / 10), MSEC_RUN_DURATION / 15);
    ...
    private void runProcessor (final IProcessor rp)
    {
        ...
        timer.schedule (timeoutAction, MSEC_RUN_DURATION);
