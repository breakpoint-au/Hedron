 ...
 */
public class BlackListVariant extends BaseEntity<String>
{
    /** Default constructor */
    public BlackListVariant ()
    {
    }
     ...
     */
    public BlackListVariant (final BlackListVariant rhs)
    {
        copyFrom (rhs);
    }
     ...
     *            The object being copied (ie the right hand side of the assignment '=').
     */
    public void copyFrom (final BlackListVariant rhs)
    {
    ...
    public static enum Columns implements IColumnIndex<BlackListVariant>
    {
        AvcId (ColumnAvcId),
