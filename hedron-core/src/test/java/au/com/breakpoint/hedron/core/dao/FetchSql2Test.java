    ...
    public void testFetchSql ()
    {
        final FetchSql2<BlackList> sql = //
            new FetchSql2<BlackList> (BlackList.Columns.AvcId).equal ("asdf") //
                ...
                .and (BlackList.Columns.ActionId).greaterThanOrEqual (1) //
                .orderBy (BlackList.Columns.AvcId).ascending () //
                .then (BlackList.Columns.DateRequested).descending () //
                .then (BlackList.Columns.OperatorId).ascending ();
